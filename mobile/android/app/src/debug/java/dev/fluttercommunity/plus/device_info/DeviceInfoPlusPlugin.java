...
// Debug-only Java shim for the device_info_plus plugin. With this AGP 9 / KGP /
// Flutter combo, device_info_plus's Kotlin plugin class isn't produced for the
// debug variant, so the generated registrant can't find it. This shim provides
// the class for debug builds only; release builds use the plugin's real
// (Kotlin) class — keeping it out of src/main avoids a duplicate-class error.
