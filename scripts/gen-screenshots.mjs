/**
 * Generates mockup screenshots for README.md using Playwright.
...
const WEB_DASHBOARD = /* html */ `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
...
<style>
  ...
  .prose p { margin: 0.25rem 0; font-size: 0.875rem; color: #44403c; }
</style>
</head>
...
<nav class="bg-white border-b border-stone-200 px-6 py-3 flex items-center justify-between">
  ...
  <div class="flex items-center gap-2 text-sm font-semibold text-stone-500">
    ...
    <a class="px-3 py-1.5 rounded-xl hover:bg-stone-50">健康</a>
    <a class="px-3 py-1.5 rounded-xl hover:bg-stone-50">設定</a>
...
<main class="max-w-4xl mx-auto px-4 py-6 space-y-5">
  ...
  <div class="grid grid-cols-4 gap-3">
    ...
    <div class="bg-white rounded-3xl p-4 flex flex-col justify-between">
      ...
      <div>
        <p class="text-xl font-black text-stone-800">62<span class="text-sm font-semibold text-stone-400"> g</span></p>
        <p class="text-xs text-stone-400">/ 234 g</p>
      </div>
  ...
  <div class="space-y-4">
    ...
    <div class="bg-white rounded-3xl overflow-hidden shadow-sm">
      <div class="flex items-center justify-between px-5 py-4 border-b border-stone-100">
        <div class="flex items-center gap-2">
          ...
          <span class="font-bold text-stone-700">早餐</span>
          <span class="text-xs text-stone-400 ml-1">08:23</span>
        </div>
        <span class="font-black text-stone-700">580 kcal</span>
      </div>
      <div class="px-5 py-3 space-y-2">
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">燕麥粥（200g）</span>
          <span class="text-stone-500">210 kcal</span>
        </div>
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">水煮蛋 ×2</span>
          <span class="text-stone-500">155 kcal</span>
        </div>
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">無糖豆漿（250ml）</span>
          <span class="text-stone-500">75 kcal</span>
        </div>
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">香蕉（1根）</span>
          <span class="text-stone-500">90 kcal</span>
        </div>
    ...
    <div class="bg-white rounded-3xl overflow-hidden shadow-sm">
      <div class="flex items-center justify-between px-5 py-4 border-b border-stone-100">
        <div class="flex items-center gap-2">
          ...
          <span class="font-bold text-stone-700">午餐</span>
          <span class="text-xs text-stone-400 ml-1">12:45</span>
        </div>
        <span class="font-black text-stone-700">720 kcal</span>
      </div>
      <div class="px-5 py-3 space-y-2">
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">雞腿便當（附飯）</span>
          <span class="text-stone-500">580 kcal</span>
        </div>
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">蔬菜湯</span>
          <span class="text-stone-500">45 kcal</span>
        </div>
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">綠茶（無糖）</span>
          <span class="text-stone-500">0 kcal</span>
        </div>
        <div class="flex gap-4 text-xs text-stone-400 pt-1 border-t border-stone-50">
    ...
    <div class="bg-white rounded-3xl overflow-hidden shadow-sm">
      <div class="flex items-center justify-between px-5 py-4 border-b border-stone-100">
        <div class="flex items-center gap-2">
          <span class="text-lg">🍵</span>
          <span class="font-bold text-stone-700">點心</span>
          <span class="text-xs text-stone-400 ml-1">15:30</span>
        </div>
        <span class="font-black text-stone-700">320 kcal</span>
      </div>
      <div class="px-5 py-3 space-y-2">
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">希臘優格（150g）</span>
          <span class="text-stone-500">130 kcal</span>
        </div>
        <div class="flex justify-between text-sm">
          <span class="text-stone-700">堅果混合（25g）</span>
          <span class="text-stone-500">148 kcal</span>
        </div>
        <div class="flex gap-4 text-xs text-stone-400 pt-1 border-t border-stone-50">
...
// ─── App screens (phone 390×844) ─────────────────────────────────────────────

const APP_DASHBOARD = /* html */ `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
...
<style>
  * { box-sizing: border-box; }
  ...
  .bottom-nav { position: fixed; bottom: 0; left: 0; right: 0; background: white; border-top: 1px solid #e7e5e4; display: flex; padding-bottom: 20px; }
...
<!-- Content -->
<div style="padding-bottom:90px; overflow-y:auto;">
  ...
  <div class="px-4 py-4 space-y-3">
    ...
    <div class="bg-white rounded-2xl overflow-hidden">
      ...
      <div class="px-4 py-2 space-y-1">
        <div class="flex justify-between text-xs text-stone-600"><span>燕麥粥、水煮蛋、豆漿</span><span class="text-stone-400">580</span></div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl overflow-hidden">
      ...
      <div class="px-4 py-2 space-y-1">
        <div class="flex justify-between text-xs text-stone-600"><span>雞腿便當、蔬菜湯</span><span class="text-stone-400">720</span></div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl overflow-hidden">
      ...
      <div class="px-4 py-2">
        <div class="flex justify-between text-xs text-stone-600"><span>希臘優格、堅果</span><span class="text-stone-400">320</span></div>
      </div>
    </div>
    ...
    <!-- Capture button -->
    <button class="w-full bg-amber-700 text-white font-bold rounded-2xl py-4 flex items-center justify-center gap-2 text-sm">
      📸 拍照新增餐點
    </button>
...
const APP_DAILY_SUMMARY = /* html */ `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=390">
...
<style>
  * { box-sizing: border-box; }
  body { font-family: system-ui, sans-serif; margin: 0; background: rgba(12,10,9,0.7); min-height: 844px; display: flex; align-items: center; justify-content: center; padding: 24px; }
</style>
</head>
<body>

<!-- Popup card -->
<div style="background:white; border-radius:24px; width:100%; max-width:342px; overflow:hidden; box-shadow:0 24px 48px rgba(0,0,0,0.3);">
  ...
  <div style="padding:20px 20px 16px; border-bottom:1px solid #e7e5e4;">
    <div style="display:flex; align-items:flex-start; justify-content:space-between;">
      ...
      <button style="background:#f5f5f4; border:none; border-radius:20px; padding:6px 12px; font-size:13px; font-weight:600; color:#78716c; cursor:pointer;">關閉</button>
    </div>
  </div>
  ...
  <div style="padding:12px 20px 16px; border-top:1px solid #e7e5e4;">
    <button style="width:100%; background:#92400e; color:white; border:none; border-radius:16px; padding:14px; font-size:15px; font-weight:700; cursor:pointer;">知道了</button>
  </div>
...
const APP_HEALTH_SYNC = /* html */ `<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=390">
<title>App Health Sync</title>
<script src="https://cdn.tailwindcss.com"></script>
<style>
  * { box-sizing: border-box; }
  body { font-family: system-ui, sans-serif; background:#f5f5f4; margin:0; }
  ...
  .card-header { padding: 14px 16px 10px; border-bottom: 1px solid #f5f5f4; display: flex; align-items: center; gap: 8px; }
  .card-title { font-size: 14px; font-weight: 700; color: #292524; }
  .badge { font-size: 11px; font-weight: 600; padding: 2px 8px; border-radius: 10px; }
  .metric-row { display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; border-bottom: 1px solid #fafaf9; }
...
<div style="padding:0 0 90px; overflow-y:auto;">
  ...
  <div style="padding:12px 16px;">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <span class="card-title">淨熱量</span>
      ...
      <div style="padding:12px 16px;">
        <div style="display:flex; justify-content:space-between; align-items:center;">
          ...
          <div style="text-align:right; font-size:12px; color:#78716c; line-height:1.8;">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <span class="card-title">體型數據</span>
        <span class="badge" style="background:#e0f2fe; color:#0369a1;">Health Connect</span>
      </div>
      <div class="metric-row">
        <span class="metric-label">體重</span>
        <div style="text-align:right;"><div class="metric-value">72.3 kg</div><div class="metric-sub">6/14 08:12</div></div>
      </div>
      <div class="metric-row">
        <span class="metric-label">身高</span>
        <div style="text-align:right;"><div class="metric-value">175 cm</div><div class="metric-sub">上次記錄</div></div>
      </div>
      <div class="metric-row" style="border-bottom:none;">
        <span class="metric-label">BMI</span>
        <div style="text-align:right;"><div class="metric-value">23.6</div><div class="metric-sub">正常範圍</div></div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        <span style="font-size:18px;">🏃</span>
        <span class="card-title">活動消耗</span>
        <span class="badge" style="background:#e0f2fe; color:#0369a1;">今日</span>
      </div>
      <div class="metric-row">
        <span class="metric-label">總消耗熱量</span>
        <div style="text-align:right;"><div class="metric-value">600 kcal</div><div class="metric-sub">基礎 + 活動</div></div>
      </div>
      <div class="metric-row">
        <span class="metric-label">步數</span>
        <div style="text-align:right;"><div class="metric-value">8,432</div><div class="metric-sub">步</div></div>
      </div>
      <div class="metric-row" style="border-bottom:none;">
        <span class="metric-label">睡眠</span>
        <div style="text-align:right;"><div class="metric-value">7:24</div><div class="metric-sub">昨晚</div></div>
      </div>
    </div>

    <!-- Sync button -->
    <button style="width:100%; background:#92400e; color:white; border:none; border-radius:16px; padding:14px; font-size:15px; font-weight:700; display:flex; align-items:center; justify-content:center; gap:8px;">
      ♻️ 立即同步 Health Connect
    </button>
...
async function shot(html, filename, width, height) {
...
await shot(WEB_DASHBOARD, "web-dashboard.png", 1280, 900);
await shot(APP_DASHBOARD, "app-dashboard.png", 390, 844);
await shot(APP_DAILY_SUMMARY, "app-daily-summary.png", 390, 844);
await shot(APP_HEALTH_SYNC, "app-health-sync.png", 390, 844);
